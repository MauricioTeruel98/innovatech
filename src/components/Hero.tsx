...
const Hero = () => {
  ...
  const bg = s.background_image || heroBg;

  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      <div className="absolute inset-0">
        <img src={bg} alt="" className="w-full h-full object-cover" width={1920} height={1080} />
      ...
      <div className="container mx-auto px-4 relative z-10 pt-20">
        <div className="max-w-2xl">
          ...
          >
            ...
            <span className="text-sm text-primary-foreground/80">{s.badge_text}</span>
          </motion.div>
          ...
          >
            <span className="text-primary-foreground">{s.heading_part1}</span>
          ...
          >
            ...
            >
              {s.primary_cta_label} <ArrowRight className="w-4 h-4" />
            </SmartLink>
            <SmartLink
              to={s.secondary_cta_url}
