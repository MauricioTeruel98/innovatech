...
export const courses: Course[] = [
  {
    ...
    longDescription: "Este curso te introduce al fascinante mundo de la Inteligencia Artificial. Aprenderás desde los conceptos básicos hasta la implementación de modelos de machine learning, pasando por redes neuronales, procesamiento de lenguaje natural y visión por computadora. Ideal para quienes quieren entender cómo funciona la IA y comenzar a aplicarla en proyectos reales.",
    duration: "8 semanas",
    students: "120+",
    level: "Principiante",
    tag: "IA",
  ...
  },
  {
    ...
    longDescription: "Domina Python como herramienta principal para la ciencia de datos. Desde el análisis exploratorio hasta modelos predictivos, este curso te enseña a trabajar con grandes volúmenes de datos, crear visualizaciones impactantes y construir modelos de machine learning que generen valor para las organizaciones.",
    duration: "10 semanas",
    students: "85+",
    level: "Intermedio",
    tag: "Data Science",
